...
class Asset(models.Model):
	...
	CATEGORY_FII = 2
	CATEGORY_BDR = 3
	CATEGORY_STOCK_SUBSCRIPTION_RIGHTS = 4
	CATEGORY_FII_SUBSCRIPTION_RIGHTS = 5
	CATEGORY_STOCK_SUBSCRIPTION = 6
	CATEGORY_FII_SUBSCRIPTION = 7
	CATEGORY_OTHERS = 5000
	CATEGORY_CHOICES = (
		(CATEGORY_STOCK, "AÇÃO"),
		(CATEGORY_FII, "FII"),
		(CATEGORY_BDR, "BDR"),
		(CATEGORY_STOCK_SUBSCRIPTION_RIGHTS, "DIR. SUBSCRIÇÃO - AÇÃO"),
		(CATEGORY_FII_SUBSCRIPTION_RIGHTS, "DIR. SUBSCRIÇÃO - FII"),
		(CATEGORY_STOCK_SUBSCRIPTION, "SUBSCRIÇÃO - AÇÃO"),
		(CATEGORY_FII_SUBSCRIPTION, "SUBSCRIÇÃO - FII"),
...
class BrokerageNote(BaseIRPFModel):
	...
	reference_id = models.PositiveBigIntegerField(verbose_name="Número da nota", null=True)
